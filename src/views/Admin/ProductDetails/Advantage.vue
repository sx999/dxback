<template>
    <div>
        ...
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item :to="{ path: '/product/advantage' }"><a href="javascript:;">产品优势</a></el-breadcrumb-item>
        </el-breadcrumb>
        <div class="boxdetail">
            <div class="funmodule">
                <div class="search">
                    <el-input v-model="search.advantageHeadline" size="medium" placeholder="请输入标题"></el-input>
            ...
            <div class="list">   
                ...
                style="width: 100%">
                    ...
                    <el-table-column
                        prop="advantageHeadline"
                        label="标题"
                        show-overflow-tooltip
                        width="180">
                    </el-table-column>
                    <el-table-column
                        prop="advantageDetails"
                        show-overflow-tooltip
                        label="内容"
                        width="230">
                    </el-table-column>
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-link type="primary" :underline="false" :href="scope.row.advantagePic"  target="_blank" class="cell">
                                {{scope.row.advantagePic}}
                            </el-link>
                        </template> 
                    </el-table-column>
                    <el-table-column 
            ...
            :close-on-click-modal="false">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px" class="demo-ruleForm">
                    <el-form-item label="标题" prop="advantageHeadline">
                        <el-input v-model="ruleForm.advantageHeadline" placeholder="请输入标题"></el-input>
                    </el-form-item>
                    <el-form-item label="内容简介" prop="advantageDetails">
                        <el-input v-model="ruleForm.advantageDetails" placeholder="请输入简述"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="预览图片:" class="block">
                        <el-link type="success" :underline="false" :href="ruleForm.advantagePic"  target="_blank"  >
                            <img :src="ruleForm.advantagePic" alt="" width="100">
                        </el-link>
                    </el-form-item>
                </el-form>
            ...
            :close-on-click-modal="false">
                <el-form :model="information" :rules="rules" ref="information" label-width="80px" class="demo-ruleForm">
                    <el-form-item label="标题" prop="advantageHeadline">
                        <el-input v-model="information.advantageHeadline" placeholder="请输入标题"></el-input>
                    </el-form-item>
                    <el-form-item label="内容" prop="advantageDetails">
                        <el-input v-model="information.advantageDetails" placeholder="请输入内容"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="预览">
                        <el-link type="success" :underline="false" :href="information.advantagePic"  target="_blank">
                            <img :src="information.advantagePic" alt="" width="100" class="block-image">
                        </el-link>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
...
export default {
    data(){
        return{
            url: 'https://dxkj2021-1306445192.cos.ap-nanjing.myqcloud.com/duxiu/34321638498087461.png',
            srcList: [
                'https://dxkj2021-1306445192.cos.ap-nanjing.myqcloud.com/duxiu/34321638498087461.png',
            ],
            loading:false, //加载动画
    ...
    methods:{
        ...
        AddData(){
            ...
            this.information.advantageDetails="",
            this.information.advantageHeadline="",
            this.information.advantagePic="",
        ...
        Affirm1(form){
             this.$refs[form].validate((valid) => {
                if (valid) {
                    this.axios.post(this.$api_router.product+'saveOne',this.information)
                    .then(res=>{
                        console.log(res)
                        if(res.data.code == 200){
        ...
        Affirm(form){
             this.$refs[form].validate((valid) => {
                if(valid) {
                    ...
                    this.axios.post(this.$api_router.product+'updateOne',this.ruleForm)
                    .then(res=>{
                        if(res.data.code == 200){
        ...
        handleDelete(index,row){
            this.$confirm("确定删除, 是否继续?", "提示", {
                    ...
                    this.axios.post(this.$api_router.product+'delOne?advantageId='+row[index].advantageId)
                    .then(res=>{
                        console.log(res)
                        if(res.data.code == 200){
        ...
        updateFace(event) {
            ...
            this.axios.post(this.$api_router.upImg,formData,{
                ...
                // console.log(res);
                this.ruleForm.advantagePic=  res.data.msg
                this.information.advantagePic =  res.data.msg
            }).catch(err => {
                console.log(err);
            });
        },
